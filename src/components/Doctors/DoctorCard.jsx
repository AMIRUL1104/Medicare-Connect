...
/**
 * DoctorCard — updated to match your real doctor document shape:
 *
 * {
 *   _id, doctorName, specialization, qualifications, experience,
 *   consultationFee, hospitalName, profileImage,
 *   availableDays: ["Monday", "Wednesday", "Friday"],
 *   availableSlots: ["03:00 PM - 06:00 PM"],
 *   verificationStatus
 * }
 *
 * Changes from the mock version:
 * - Uses `_id` instead of `id` for the link and key
 * - Removed `rating` (not present in your schema) — added back only
 *   if/when you add a rating field to the doctor or a separate
 *   reviews aggregate
 * - Shows `availableDays` (already in your schema) instead of a
 *   computed "available days" guess
 */
export default function DoctorCard({ doctor }) {
  ...
  function formatDays(days) {
    ...
    // Shorten "Monday" -> "Mon" for compact display
