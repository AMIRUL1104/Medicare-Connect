  ...
  return (
    <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 lg:p-8">
      <div className="flex flex-col sm:flex-row gap-6">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-3 flex-wrap">
            <div>
              <h1 className="text-xl lg:text-2xl font-bold text-[#1E293B]">{doctorName}</h1>
              <p className="text-[#0EA5E9] font-medium text-sm mt-0.5">{specialization}</p>
            </div>
      ...
      <div className="mt-6 pt-6 border-t border-[#E2E8F0]">
        <p className="text-xs font-semibold text-[#94A3B8] uppercase tracking-wide mb-2.5">Available Days</p>
